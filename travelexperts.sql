...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2019 at 01:06 AM
...
CREATE TABLE `agents` (
  ...
  `AgtPhone` varchar(20) DEFAULT NULL,
  ...
  `AgtUserPwd` varchar(60) DEFAULT NULL
...
INSERT INTO `agents` (`AgentId`, `AgtFirstName`, `AgtMiddleInitial`, `AgtLastName`, `AgtPhone`, `AgtEmail`, `AgtPosition`, `AgencyId`, `AgtUserId`, `AgtUserPwd`) VALUES
(1, 'Janet', NULL, 'Delton', '(403) 210-7801', 'janet.delton@travelexperts.com', 'Senior Agent', 1, 'JDelton', 'P@ssw0rd'),
(2, 'Judy', NULL, 'Lisle', '(403) 210-7802', 'judy.lisle@travelexperts.com', 'Intermediate Agent', 1, 'JLisle', 'P@ssw0rd'),
(3, 'Dennis', 'C.', 'Reynold', '(403) 210-7843', 'dennis.reynolds@travelexperts.com', 'Junior Agent', 1, 'DReynolds', 'P@ssw0rd'),
(4, 'John', NULL, 'Coville', '(403) 210-7823', 'john.coville@travelexperts.com', 'Intermediate Agent', 1, 'JCoville', 'P@ssw0rd'),
(5, 'Fred', 'J', 'Smith', '(403) 210-5555', 'fred@travelexperts.com', 'Junior Agent', 2, 'FSmith', 'P@ssw0rd'),
(6, 'Bruce', 'J.', 'Dixon', '(403) 210-7867', 'bruce.dixon@travelexperts.com', 'Intermediate Agent', 2, 'BDixon', 'P@ssw0rd'),
(7, 'Beverly', 'S.', 'Jones', '(403) 210-7812', 'beverly.jones@travelexperts.com', 'Intermediate Agent', 1, 'BJones', 'P@ssw0rd'),
(8, 'Jane', NULL, 'Merrill', '(403) 210-7868', 'jane.merrill@travelexperts.com', 'Senior Agent', 2, 'JMerrill', 'P@ssw0rd'),
(9, 'Brian', 'S.', 'Peterson', '(403) 210-7833', 'brian.peterson@travelexperts.com', 'Junior Agent', 2, 'BPeterson', 'P@ssw0rd');
...
CREATE TABLE `bookings` (
  ...
  `TripType` varchar(10) CHARACTER SET latin1 DEFAULT NULL,
...
INSERT INTO `bookings` (`BookingId`, `BookingDate`, `CustomerId`, `TravelerCount`, `TripType`, `PackageId`, `TripStart`, `TripEnd`) VALUES
(1, '2019-10-10', 140, 2, 'Leisure', 2, '2019-10-10', '2019-10-10'),
(2, '2019-09-01', 111, 1, 'Business', 2, '2019-09-01', '2019-09-01'),
(3, '2019-10-19', 143, 4, 'Leisure', 1, '2019-10-19', '2019-10-19'),
(4, '2019-10-20', 104, 2, 'Leisure', 1, '2019-10-20', '2019-10-20'),
(12, '2019-10-22', 104, 1, 'Leisure', 1, '2019-10-22', '2019-10-22'),
(13, '2019-10-28', 145, 1, 'Leisure', 1, '2019-10-28', '2019-10-28');
...
CREATE TABLE `customers` (
  ...
  `CustAddress` varchar(75) DEFAULT NULL,
  `CustCity` varchar(50) DEFAULT NULL,
  `CustProv` varchar(2) DEFAULT NULL,
  `CustPostal` varchar(7) DEFAULT NULL,
  `CustCountry` varchar(25) DEFAULT NULL,
  `CustPhone` varchar(20) DEFAULT NULL,
  `CustEmail` varchar(50) DEFAULT NULL,
  `AgentId` int(11) DEFAULT NULL,
  `CustUserId` varchar(50) DEFAULT NULL,
  `CustUserPwd` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `customers` (`CustomerId`, `CustFirstName`, `CustLastName`, `CustAddress`, `CustCity`, `CustProv`, `CustPostal`, `CustCountry`, `CustPhone`, `CustEmail`, `AgentId`, `CustUserId`, `CustUserPwd`) VALUES
(104, 'Laetia', 'Enison', '144-61 87th Ave, NE', 'Calgary', 'AB', 'T2J 6B6', 'Canada', '4032791223', 'laetia.enison@google.ca', 4, 'LEnison', 'P@ssw0rd'),
(105, 'Angel', 'Moskowitz', '320 John St., NE', 'Calgary', 'AB', 'T2J 7E3', 'Canada', '4032794228', 'amoskowitz@home.com                               ', 3, 'AMoskowitz', 'P@ssw0rd'),
(106, 'Judith', 'Olvsade', '29 Elmwood Ave.,', 'Calgary', 'AB', 'T2Z 3M9', 'Canada', '4032795652', 'jolvsade@aol.com                                  ', 1, 'JOlvsade', 'P@ssw0rd'),
(107, 'Catherine', 'Mierzwa', '22-70 41st St.,NW', 'Calgary', 'AB', 'T2Z 2Z9', 'Canada', '4032796878', 'cmierzwa@msn.com                                  ', 4, 'CMierzwa', 'P@ssw0rd'),
(108, 'Judy', 'Sethi', '63 Stratton Hall, SW', 'Calgary', 'AB', 'T1Y 6N4', 'Canada', '4032795111', 'judysehti@home.com                                ', 7, 'JSethi', 'P@ssw0rd'),
(109, 'Larry', 'Walter', '38 Bay 26th ST. #2A, NE', 'Calgary', 'AB', 'T2J 6B6', 'Canada', '4032793254', 'lwalter@aol.com                                   ', 4, 'LWalter', 'P@ssw0rd'),
(114, 'Winsome', 'Laporte', '268 E.3rd St, SW', 'Calgary', 'AB', 'T1Y 6N4', 'Canada', '4032691125', '                                                  ', 8, 'WLaporte', 'P@ssw0rd'),
(117, 'Nancy', 'Kuehn', '44-255 9th St., SW', 'Calgary', 'AB', 'T1Y 6N5', 'Canada', '4032693965', '                                                  ', 6, 'NKuehn', 'P@ssw0rd'),
(118, 'Hiedi', 'Lopez', '168 Rowayton Ave, NW', 'Calgary', 'AB', 'T3A 4ZG', 'Canada', '4032699856', 'hlopez@aol.com                                    ', 4, 'HLopez', 'P@ssw0rd'),
(119, 'Mardig', 'Abdou', '160-04 32nd Ave., SW', 'Calgary', 'AB', 'T2P 2G7', 'Canada', '4032691429', '                                                  ', 9, 'MAbdou', 'P@ssw0rd'),
(120, 'Ralph', 'Alexander', '2054 73rd St, SW', 'Calgary', 'AB', 'T2P 2G7', 'Canada', '4032691634', '                                                  ', 1, 'RAlexander', 'P@ssw0rd'),
(121, 'Sean', 'Pineda', '3 Salem Rd., NW', 'Calgary', 'AB', 'T2K 3E3', 'Canada', '4032691954', 'spineda@hotmail.com                               ', 3, 'SPineda', 'P@ssw0rd'),
(122, 'Julita', 'Lippen', '51-76 VanKleeck St., NW', 'Calgary', 'AB', 'T2K 6C5', 'Canada', '4032551956', 'jlippen@cadvision.co                              ', 4, 'JLippen', 'P@ssw0rd'),
(123, 'Pierre', 'Radicola', '322 Atkins Ave., SE', 'Calgary', 'AB', 'T3G 2C6', 'Canada', '4032551677', 'pradicola@home.com                                ', 8, 'PRadicola', 'P@ssw0rd'),
(127, 'Gary', 'Aung', '135-32 Louis Blvd, NE', 'Calgary', 'AB', '', 'Canada', '4032807858', '                                                  ', 9, 'GAung', 'P@ssw0rd'),
(128, 'Jeff', 'Runyan', '109-15 Queens Blvd., NE', 'Calgary', 'AB', 'T2V 2K6', 'Canada', '4032809635', 'jrunyan@aol.com                                   ', 4, 'JRunyan', 'P@ssw0rd'),
(130, 'Lula', 'Oates', '11A Emory St., NE', 'Calgary', 'AB', 'T3E 3Z4', 'Canada', '4032439653', 'loates@aol.com                                    ', 9, 'LOates', 'P@ssw0rd'),
(133, 'James', 'Reed', '109-621 96th St, NE', 'Calgary', 'AB', 'T3E 4A1', 'Canada', '4032432358', 'jreed@aol.com                                     ', 2, 'JReed', 'P@ssw0rd'),
(135, 'Michelle', 'Masser', '379 Ovington Ave, NE', 'Calgary', 'AB', 'T2J 2S9', 'Canada', '4032441586', 'mmasser@aol.com                                   ', 6, 'MMasser', 'P@ssw0rd'),
(138, 'John', 'Smith', '45 Plaza St. West #2D, NE', 'Calgary', 'AB', 'T3E 5C7', 'Canada', '4032449653', 'johnSmith@hotmail.co                              ', 7, 'JSmith', 'P@ssw0rd'),
(139, 'Angelo', 'Garshman', '82 Western Ave., NE', 'Calgary', 'AB', 'T3E 5C8', 'Canada', '4032259966', '                                                  ', 3, 'AGarshman', 'P@ssw0rd'),
(140, 'Derrick', 'Baltazar', '9111 Church Ave. #3N, NE', 'Calgary', 'AB', 'T3E 5C9', 'Canada', '4032255231', '                                                  ', 6, 'DBaltazar', 'P@ssw0rd'),
(141, 'Robert', 'Boyd', '96-04 57th Ave #12A, NE', 'Calgary', 'AB', 'T3E 5C5', 'Canada', '4032255647', '                                                  ', 3, 'RBoyd', 'P@ssw0rd'),
(142, 'Monica', 'Waldman', '257 Depot Rd., NE', 'Calgary', 'AB', 'T2J 6P3', 'Canada', '4032255629', 'mwaldman@aol.com                                  ', 2, 'MWaldman', 'P@ssw0rd'),
(143, 'Gerard', 'Biers', '205 19th St., NE', 'Calgary', 'AB', 'T2J 6B6', 'Canada', '4032251952', '                                                  ', 8, 'GBiers', 'P@ssw0rd'),
(144, 'Shanice', 'Talan', 'test', 'Calgary', 'AB', 'T3B 4C3', 'Canada', '4039099908', 'shanicetalan@test.com', NULL, 'STalan', 'P@ssw0rd');
...
CREATE TABLE `packages` (
  ...
  `PkgBasePrice` decimal(19,2) DEFAULT NULL,
  `PkgAgencyCommission` decimal(19,2) DEFAULT NULL,
  `PkgImg` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Caribbean New Year', '2020-03-30', '2021-06-30', 'Cruise the Caribbean', '4800.00', '400.00', 'caribbean.jpg'),
(2, 'Polynesian Paradise', '2020-11-30', '2021-12-30', 'All Inclusive Hawaiian Vacation', '3000.00', '320.00', 'hawaii.jpg'),
(3, 'Asian Expedition', '2020-04-30', '2021-05-29', 'Airfaire, Hotel and Eco Tour.', '2800.00', '300.00', 'japan.jpg'),
(4, 'European Vacation', '2020-12-30', '2020-12-30', 'Euro Tour with Rail Pass', '3000.00', '280.00', 'eiffel.jpg'),
(5, 'Winter Holiday', '2019-10-31', '2020-10-01', 'Winter Canada tour', '2000.00', '300.00', NULL);
...
INSERT INTO `provinces` (`provCode`, `provName`, `country`) VALUES
('AB', 'Alberta', 'Canada'),
